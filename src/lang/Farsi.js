...
پس از وارد کردن آن، باید یک فایل تراکنش نهایی جدید را ذخیره کنید و آن را برای فرستنده ارسال کنید <br/>`
  },
  {
    ...
    text: `
یا عبارات بازیابی، کلماتی هستند که برای بازیابی کیف پول خود به آن نیاز دارید
...
همتایان، نودهای شبکه دیگری هستند که به نود شبکه شما متصل هستند <br/>`
  ...
  {
    title: '' ارتفاع بلاک چین Blockchain Height',
    text: `
ارتفاع بلاک چین آخرین عدد بلاک در زنجیره است. هر 60 ثانیه بلاک چین اپیک یک بلاک جدید ایجاد می کند و مقدار ارتفاع تغییر می کند<br/>`
  },
