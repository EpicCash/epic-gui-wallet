...
app.provide('walletService', new walletService(emitter, config));
app.provide('nodeService', new nodeService(emitter, config));
app.provide('ngrokService', new ngrokService(emitter, config));


app.provide('userService', new userService());
app.provide('addressBookService', new addressbookService());
app.provide('addressTransactionsService', new addressTransactionsService());
app.provide('configService', config);
app.provide('mnemonicWords', words);
