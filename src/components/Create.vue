...
export default {
  ...
  created(){
    ...
    window.nodeChildProcess.on('walletCreated', (data) => {
      log.debug('create.vue got walletCreated event.')
      this.walletCreating= false
      this.walletCreated = true
      this.seeds = data.data.split(' ')
    });

    window.nodeChildProcess.on('walletCreateFailed', ()=>{
      this.error = true
