const messages = [
  {
    ...
    <br/>
تراکنش ها میتوانند آنی و توسط استفاده از شبکه تور و یا آدرس اچ تی تی پی(اس)
صورت بگیرند، و یا بصورت دستی با معاوضه کردن فایل صورت بگیرد<br/><br/>
برای شروع تراکنش، مطمئن شوید که نود یا گِره سرور شما کاملا سینک یا همگام سازی شده است<br/></br>
    در سرور نود شما باید کلمه"همگام سازی شد" نوشته شده باشد
     “synced“ <br/><br/>آدرس گیرنده میتواند هم شبکه پیازی تور و یا هر آدرس اچ تی تی پی(اس)
    خارجی ای باشد <br/>
    <br/>
...
<br/>`,
  },
  {
    ...
    text:
` برای دریافت سکه ها، کیف پول شما باید در حالت گوش دادن باشد
listen mode
 <br/><br/>
    هر بار که شنونده را شروع/راه‌اندازی مجدد می‌کنید، آدرس اِنگِروک
...
شناسه تراکنش، شناسه منحصر به‌ فردی برای هر تراکنش است که توسط گیرنده و فرستنده به اشتراک گذاشته شده است <br/>`
  },
  {
    ...
    text: ` آی دی یا شناسه ی سکه، شناسه منحصر به فرد سکه های شما در بلاک چین است <br/>
...
هر بار که شنونده را استارت یا شروع می کنید، آدرس اِنگروک شما تغییر می کند `
  },
  {
    title: ' حساب Account',
    text: `
نام کاربری و نام حساب کی بِیس
خود را در قسمت حساب تنظیم کنید <br/>
    <br/>
...
در اینجا می توانید تنظیمات انجام شده در طی فرآیند راه اندازی کیف پول را تغییر دهید <br/>`
  },
  {
    ...
    text: `
این مکان سرور نود یا گِره شما است<br/>
    <br/>
یک سرور نود برای ارسال و دریافت سکه توسط کیف پول مورد نیاز است <br/>
    <br/>
شما می توانید بین سرور نود داخلی در کیف پول شما و یا سرور نود خارجی، یکی را انتخاب کنید <br/><br/>
 اگر این تنظیم را تغییر دادید، لطفا کیف پول خود را مجددا راه اندازی کنید <br/>`
  },
  {
    title: 'Your Ngrok Authtoken',
    text: `
داشتن ۀت توکن در سرور اِنگِروک
برای پیدا کردن کیف پول کامپیوتر شما ضروری می باشد <br/><br/>
اگر نمی خواهید از سرویس اِنگِروک
استفاده کنید، قسمت ، آت توکن اِنگِروک
را خالی بگذارید<br/>`
  },
  {
...
آدرس  تور خود را در صفحه "دریافت" پیدا خواهید کرد <br/>`
  ...
  {
    title: 'Ngrok اِنگِروک',
    text: `
 اِنگِروک
 سرویسی است که یک آدرس عمومی ای ارائه می دهد که به آدرس آی پی خصوصی پشت مودم کیف پول شما پیوند داده شده است <br/><br/>
شما میتوانید آدرس
اِنگِروک
را با فرستندگان به کیف پول شما، به اشتراک بگذارید یا از آن به عنوان آدرس دریافت در صرافی یا اکسچنج ها، استفاده کنید<br/>`
  },
  {
    title: ' نود یا گره شبکه Network node',
    text: `
...
اولین باری که نود داخلی خود کیف را اجرا می کنید، تقریباً 2 ساعت برای سینک کردن یا همگام سازی داده های بلاک چین، طول می کشد`
  },
  {
    title: ' جفت ها یا همتایان Peers',
    text: `
جفت ها یا همتایان، نودهای شبکه دیگری هستند که به نود شبکه شما متصل هستند <br/>`
  },
  {
    title: 'ارتفاع بلاک چین',text: `ارتفاع بلاک چین آخرین عدد بلاک در زنجیره یا چِین است. هر 60 ثانیه، بلاک چِینِ اِپیک، یک بلاکِ جدید ایجاد می کند و مقدار ارتفاع تغییر می کند<br/>`
  },
